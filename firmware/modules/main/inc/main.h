...
#define SERVO_RIGHT_FORWARD_CHANNEL TIM_CHANNEL_1
#define SERVO_RIGHT_REVERSE_CHANNEL TIM_CHANNEL_2
#define SERVO_LEFT_FORWARD_CHANNEL TIM_CHANNEL_3
#define SERVO_LEFT_REVERSE_CHANNEL TIM_CHANNEL_4
